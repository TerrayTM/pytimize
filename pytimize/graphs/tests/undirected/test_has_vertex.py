...
class TestHasVertex(TestCase):
    ...
    def test_negative(self) -> None:
        self.assertFalse(
            self.g.has_vertex("w"), "Should check if vertex does not exist."
        )
        self.assertFalse(
            self.g.has_vertex("m"), "Should check if vertex does not exist."
        )
        self.assertFalse(
            self.g.has_vertex("g"), "Should check if vertex does not exist."
        )

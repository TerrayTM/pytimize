...
class TestCopy(TestCase):
    def test_copy(self) -> None:
        ...
        self.assertIsNot(copy._edges, g._edges, "Should not be the same dictionary instance.")
        self.assertIsNot(copy._vertices, g._vertices, "Should not be the same dictionary instance.")
        self.assertIsNot(copy._graph, g._graph, "Should not be the same dictionary instance.")

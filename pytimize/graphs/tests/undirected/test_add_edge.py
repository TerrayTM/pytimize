...
class TestAddEdge(TestCase):
    def test_add_edge(self) -> None:
        ...
        self.assertEqual(g.vertices, {"a": 0, "b": 0, "c": 0, "e": 0, "f": 0, "abc": 0, "def": 0}, "Should add the correct vertices.")
        self.assertEqual(g.edges, {("a", "b"): 1, ("b", "c"): 2, ("e", "f"): 3, ("abc", "def"): 3}, "Should add the correct edges.")
        self.assertEqual(g.graph, {"a": {"b"}, "b": {"c", "a"}, "c": {"b"}, "e": {"f"}, "f": {"e"}, "abc": {"def"}, "def": {"abc"}}, "Should be the correct graph.")

...
class TestSetEdgeWeight(TestCase):
    ...
    def test_set_edge_weight(self) -> None:
        ...
        self.assertEqual(self.g.get_edge_weight(("a", "b")), 5, "Should set edge weight properly.")

        self.g.set_edge_weight(("b", "a"), 10)

        self.assertEqual(self.g.get_edge_weight(("a", "b")), 10, "Should set edge weight properly.")

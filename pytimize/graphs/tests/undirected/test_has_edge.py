...
class TestHasEdge(TestCase):
    ...
    def test_negative(self) -> None:
        self.assertFalse(
            self.g.has_edge(("z", "z")), "Should check if edge does not exist."
        )
        self.assertFalse(
            self.g.has_edge(("b", "w")), "Should check if edge does not exist."
        )
        self.assertFalse(
            self.g.has_edge(("b", "f")), "Should check if edge does not exist."
        )

...
class TestEq(TestCase):
    ...
    def test_empty(self) -> None:
        self.assertEqual(
            UndirectedGraph(), UndirectedGraph(), "Should compare empty graphs."
        )

    def test_negative(self) -> None:
        edges_one = {("a", "b"): 10, ("b", "c"): 20, ("l", "m"): 30}
        edges_two = {("a", "b"): 10, ("b", "c"): 20, ("l", "q"): 30}

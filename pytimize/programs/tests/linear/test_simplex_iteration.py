...
class TestSimplexIteration(TestCase):
    def test_simplex_iteration(self) -> None:
        ...
        self.assertEqual(basis, [2, 4], "Should compute correct basis.")
        self.assertTrue(np.allclose(solution, [0, 1, 0, 1]), "Should compute correct solution.")
    ...
    def test_invalid_basis(self) -> None:
        ...
        with self.assertRaises(ValueError, msg="Should throw exception if given invalid basis."):
    ...
    def test_non_sef(self) -> None:
        ...
        with self.assertRaises(ArithmeticError, msg="Should throw exception if not in SEF."):
